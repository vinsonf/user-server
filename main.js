...
const img = document.querySelector('img');
    fetch(baseUrl + '/list-files',{
        ...
        data.files.forEach(function(file) {
            ...
            run.innerHTML = 'Run';        const button = document.createElement('button');
            button.innerHTML = 'unlink';
            li.style.display = 'flex';
            li.style.justifyContent = 'space-between';
            button.addEventListener('click', function() {
                fetch(baseUrl + '/unlink/' + btoa(file.pathToFIle)).then(function(response) {
            ...
            dButton.addEventListener('click', function() {
                fetch(baseUrl + '/send/' + btoa(file.pathToFIle)).then(function(response) {
